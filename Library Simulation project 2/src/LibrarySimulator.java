//Abdulkreem ID:455102636
//Mohamed ID:446104209
// Khalid ID:445101037
...
public class LibrarySimulator {  
    public static void main(String[] args) {  
        ...
        // Predefined members  
        Member Abdulkreem = new Member(1, "Abdulkreem", 0);  
        Member khalid = new Member(2, "Khalid", 0);  
        Member Mohamed = new Member(3, "Mohamed", 0);  
        ...
        while (running) {  
            ...
            System.out.println("1. Login as " + Abdulkreem.getName() + " (ID: " + Abdulkreem.getId() + ")");  
            System.out.println("2. Login as " + khalid.getName() + " (ID: " + khalid.getId() + ")");  
            System.out.println("3. Login as " + Mohamed.getName() + " (ID: " + Mohamed.getId() + ")");  
